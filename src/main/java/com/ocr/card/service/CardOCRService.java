...
public class CardOCRService implements ICardOCRService {
    ...
    @Override
    public Card getCardData(/*File*/BufferedImage file){
        ...
        // Capture LastName  1537/966(me)   1013/603(abd)
        x1 = 0.32;//0.13;
        y1 = 0.29;//0.43;
        x2 = 0.71;//0.58;
        y2 = 0.39;//0.52;
        ...
        System.out.println("LastName: "+ cardData.getLastName());
        System.out.println("FirstName: "+ cardData.getFirstName());
        System.out.println("Reference (CNE): "+ cardData.getReference());
        System.out.println("CardNumber: "+ cardData.getCardNumber());
        System.out.println("BirthDate: "+ cardData.getBirthDate());
